...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <div className="grid place-items-center overflow-auto h-screen fixed inset-0 z-[1100] bg-black/20  data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0">
      ...
      >
        {children}
        <DialogPrimitive.Close className="bg-primary z-[1200] text-primary-foreground size-7 flex items-center justify-center absolute right-4 top-4 rounded-sm ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground">
