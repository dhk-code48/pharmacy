...
export function DataTableFilterControls<TData, TValue>({ table, columns, filterFields }: DataTableFilterControlsProps<TData, TValue>) {
    ...
    <div className="flex flex-col gap-4">
      ...
      >
        {filterFields?.map((field) => {
          return (
            <AccordionItem key={field.value as string} value={field.value as string} className="border-none">
