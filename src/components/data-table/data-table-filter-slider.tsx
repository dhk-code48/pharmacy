...
export function DataTableFilterSlider<TData>({ table, value: _value, min, max }: DataTableFilterSliderProps<TData>) {
      ...
      <div className="flex items-center gap-4">
        <div className="grid w-full gap-1.5">
          ...
          <InputWithAddons
            ...
            onChange={(e) => {
              ...
              const newValue = Array.isArray(filters) && val < filters[1] ? [val, filters[1]] : [val, max];
        ...
        <div className="grid w-full gap-1.5">
          ...
          <InputWithAddons
            ...
            onChange={(e) => {
              const val = Number.parseInt(e.target.value) || 0;
              const newValue = Array.isArray(filters) && val > filters[0] ? [filters[0], val] : [min, val];
              column?.setFilterValue(newValue);
              updatePageSearchParams({
                [value]: newValue.join(SLIDER_DELIMITER),
              });
