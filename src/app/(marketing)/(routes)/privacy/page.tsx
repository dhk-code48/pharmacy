...
const PrivacyPolicy = () => {
  return (
    <MaxWidthWrapper className="prose dark:prose-invert py-10 px-2">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            Agreement) refers to My Company LLC, My Company Address.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Multitenant Pharmacy, accessible from{" "}
            <a href="https://www.multitenant-pharmacy.com" rel="external nofollow noopener" target="_blank">
              https://www.multitenant-pharmacy.com
            </a>
          </p>
        </li>
        <li>
      ...
      <p>
        ...
        If You choose to provide such information and Personal Data, during registration or otherwise, You are giving the Company permission to use,
      ...
      <ul>
        <li>
          <p>By email: info@multitenant-pharmacy.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a href="https://multitenant-pharmacy.com/contact" rel="external nofollow noopener" target="_blank">
              https://multitenant-pharmacy.com/contact
            </a>
          </p>
        </li>
        <li>
          <p>By phone number: +977 9704484066</p>
        </li>
      </ul>
      use privacy policy as reference and make terms of service page
    </MaxWidthWrapper>
  );
};
