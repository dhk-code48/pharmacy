    ...
    session.user.id === params.userId && (
      <div className="relative flex min-h-screen">
        ...
        <div className="flex flex-1 flex-col">
          <header className="sticky top-0 z-50 hidden md:flex h-14 bg-background px-4 lg:h-[60px] xl:px-8 border-b">
            <MaxWidthWrapper className="flex max-w-7xl items-center gap-x-3 px-0 mx-auto" large>
              <div className="lg:hidden">
                <MobileSheetSidebar links={USER_DASHBOARD_SIDEBAR} prefix={`/user/${params.userId}`} />
              </div>
